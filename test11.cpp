...
int main()
{
	...
	do
	{
		...
		case 'A':
		{
			Heap< TestDataItem<int>, int, Greater<> > testHeap2(testHeap);
			cout << "Other heap:" << endl;
			testHeap2.showStructure();
			cout << endl << "This heap:" << endl;
			break;
		}
#if LAB11_TEST1
...
void printHelp()
{
	...
	cout << "  A    : Copy this heap into another" << endl;
	cout << "  W    : Write levels   ("
#if LAB11_TEST1
		"Active   "
#else
